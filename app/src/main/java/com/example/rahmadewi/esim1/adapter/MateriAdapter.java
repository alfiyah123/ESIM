...
public class MateriAdapter extends BaseExpandableListAdapter {

    private Context context;
    private List<String> expandableListTitle;
    private HashMap<String, List<String>> expandableListDetail;

    public MateriAdapter(Context context, List<String> expandableListTitle, HashMap<String, List<String>> expandableListDetail) {
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        if(view == null) {
            ...
            view = layoutInflater.inflate(R.layout.materi_group, null);
        }
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = layoutInflater.inflate(R.layout.materi_item, null);
        }
